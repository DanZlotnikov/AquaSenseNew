"""ML vs GT comparison on ACQ_5_3_2026 — carp_presence_v5_knockdown ensemble."""
...
OUT_TXT    = DATA_DIR / "ml_vs_gt_comparison_v5_knockdown.txt"
...
def main():
    ...
    lines = [
        ...
        f"Detection model : carp_presence_v5_knockdown ensemble",
        f"Normalization   : per-recording z-score, SIGMA_FLOOR={SIGMA_FLOOR}",
        f"Augmentation    : F-knockdown + B-knockdown negatives in training",
