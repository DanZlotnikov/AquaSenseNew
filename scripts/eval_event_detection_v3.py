"""
Event-level detection evaluation for carp_presence_v3 ensemble.
...
Outputs:
  results/event_detection_eval_v3/summary.txt
  results/event_detection_eval_v3/per_file.csv
  results/event_detection_eval_v3/nms_sweep.csv
"""
...
OUT_DIR   = _ROOT / "results" / "event_detection_eval_v3"
...
def main():
    ...
    summary = (
        f"Event-level detection evaluation — carp_presence_v3\n"
        f"{'='*65}\n"
