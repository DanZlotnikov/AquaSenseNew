"""ML vs GT comparison on ACQ_5_3_2026 using carp_presence_v2 ensemble."""
...
OUT_TXT    = DATA_DIR / "ml_vs_gt_comparison_v2.txt"
...
def main():
    ...
    lines.append(f"Detection model : carp_presence_v2 ensemble ({CKPT_DIR.name})")
